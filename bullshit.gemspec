...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["README.rdoc", "lib/bullshit/comparison.rb", "lib/bullshit/version.rb", "lib/bullshit/case_method.rb", "lib/bullshit/common_constants.rb", "lib/bullshit/range_case.rb", "lib/bullshit/module_functions.rb", "lib/bullshit/repeat_case.rb", "lib/bullshit/evaluation_module.rb", "lib/bullshit/time_case.rb", "lib/bullshit/clock.rb", "lib/bullshit/case.rb", "lib/bullshit.rb"]
  s.files = [".gitignore", ".travis.yml", "CHANGES", "COPYING", "Gemfile", "README.rdoc", "Rakefile", "VERSION", "bin/bs_compare", "bullshit.gemspec", "data/.keep", "examples/compare.rb", "examples/fibonacci.rb", "examples/iteration.rb", "examples/josephus.rb", "examples/sorting.rb", "examples/throw_raise.rb", "lib/bullshit.rb", "lib/bullshit/case.rb", "lib/bullshit/case_method.rb", "lib/bullshit/clock.rb", "lib/bullshit/common_constants.rb", "lib/bullshit/comparison.rb", "lib/bullshit/evaluation_module.rb", "lib/bullshit/module_functions.rb", "lib/bullshit/range_case.rb", "lib/bullshit/repeat_case.rb", "lib/bullshit/time_case.rb", "lib/bullshit/version.rb", "tests/bullshit_test.rb", "tests/test_helper.rb", "tests/window_test.rb"]
